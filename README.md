...
- [x] Mapear minha carreira com o Canvas de Carreira
- [x] Criar meu README de Perfil Profissional
- [ ] Subir 2 projetos completos com documentação no GitHub
- [ ] Melhorar meu nível de Inglês para leitura técnica
...
|---------|-----------|-----------------|
| NeoStock | Sistema focado em previsão de demanda e controle de estoque. | C |
| Em breve | Estou construindo um projeto baseado em Algoritimos e Pensamento Computacionais. | Em desenvolvimento |

## Como Falar Comigo
- [linkedin](https://www.linkedin.com/in/ray-vieira-melo-8b31823a8)
- [gmail](raymelo243@gmail.com)
